...
function renderGitHubEvents(container, events) {
    ...
    // Performance optimization: Replace filter+slice chain with a short-circuiting for loop
    // to avoid iterating over potentially thousands of events after finding the first 5.
