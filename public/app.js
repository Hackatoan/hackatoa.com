...
function handleWheel(e) {
    ...
    // Bolt optimization: Early exit during slides to prevent DOM layout thrashing
    // from target.closest or scrollTop/clientHeight reads in the high-frequency wheel listener.
    if (isSliding) {
        e.preventDefault();
        return;
    }
