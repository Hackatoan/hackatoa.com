...
function handleWheel(e) {
    ...
    // Optimization: Early exit if sliding to prevent layout thrashing and animation jank
    // before any DOM traversals or layout property reads in this high-frequency event.
    if (isSliding) {
        e.preventDefault();
        return;
    }
