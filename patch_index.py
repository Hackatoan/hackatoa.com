...
# Replace the inner content of .video-bg
start_idx = content.find('<div class="video-bg" aria-hidden="true">')
end_idx = content.find('</div>\n\n  <main>', start_idx) + len('</div>')

if start_idx == -1 or end_idx == -1:
    print("Could not find video-bg div")
else:
    svg_content = """<div class="video-bg" aria-hidden="true">
    <svg version="1.1" id="mountain" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 1280 1024" preserveAspectRatio="xMidYMid slice" style="enable-background:new 0 0 1280 1024;" xml:space="preserve">
<style type="text/css">
	.st0{fill:url(#bg_1_);}
	.st1{fill:#FFFFFF;}
	.st2{fill:#FFE09D;}
...
<radialGradient id="bg_1_" cx="646.8936" cy="690.0859" r="580.0529" gradientUnits="userSpaceOnUse">
...
<g id="volcano">
	...
	<g id="bubbleGroup">
		<g>
			<circle class="st5" cx="646.9" cy="915.1" r="40.6"/>
			<path class="st6" d="M611.1,933.7c-1.3-2.2-2.3-4.6-3.1-7c-0.4-1.2-0.7-2.5-1-3.8c-0.3-1.3-0.5-2.6-0.6-3.9c0-0.3-0.1-0.7-0.1-1
				l0-0.5c0-0.2,0-0.3,0-0.5l-0.1-2c0-0.7,0-1.3,0-2c0-0.7,0.1-1.3,0.1-2c0.3-2.6,0.8-5.3,1.6-7.8c0.8-2.6,1.8-5,3.1-7.4
				c1.3-2.4,2.8-4.6,4.5-6.7c3.4-4.2,7.7-7.6,12.5-10.2l0.9-0.5c0.3-0.2,0.6-0.3,0.9-0.4l0.9-0.4l0.5-0.2l0.2-0.1l0.2-0.1l0.9-0.4
				l0.5-0.2c0.2-0.1,0.3-0.1,0.5-0.2c0.6-0.2,1.3-0.4,1.9-0.6c2.6-0.8,5.3-1.3,7.9-1.5c0.2,0,0.3,0,0.5-0.1l0.5,0l1-0.1l0.5,0
				c0.2,0,0.3,0,0.5,0l1,0c1.3,0,2.7,0.1,4,0.2l1,0.1l1,0.1c0.2,0,0.3,0,0.5,0.1l0.5,0.1c0.3,0.1,0.7,0.1,1,0.2
				c1.3,0.3,2.6,0.6,3.9,1c5.1,1.6,9.8,4.2,13.9,7.6c1,0.9,2,1.7,2.9,2.7c0.9,0.9,1.8,1.9,2.6,2.9c0.8,1,1.5,2.1,2.2,3.2
				c0.7,1.1,1.3,2.2,1.8,3.4c-0.8-1-1.6-2-2.5-2.9c-0.9-0.9-1.8-1.8-2.7-2.7c-0.9-0.8-1.9-1.6-2.9-2.4c-1-0.8-2-1.5-3-2.1
				c-4.1-2.7-8.7-4.6-13.4-5.6c-1.2-0.3-2.4-0.5-3.5-0.6c-0.3,0-0.6-0.1-0.9-0.1l-0.4-0.1c-0.1,0-0.3,0-0.4,0l-0.9-0.1l-0.9,0
				c-1.2,0-2.4-0.1-3.6,0l-0.9,0c-0.1,0-0.3,0-0.4,0l-0.4,0l-0.9,0.1l-0.4,0c-0.1,0-0.3,0-0.4,0.1l-0.9,0.1l-0.4,0.1
				c-0.1,0-0.1,0-0.2,0l-0.2,0l-0.9,0.2l-0.4,0.1c-0.1,0-0.3,0.1-0.4,0.1l-1.7,0.4L637,881l-1.7,0.6c-0.1,0-0.3,0.1-0.4,0.2
				l-0.4,0.2l-0.8,0.3l-0.2,0.1l-0.2,0.1l-0.4,0.2l-0.8,0.4c-0.3,0.1-0.5,0.3-0.8,0.4l-0.8,0.4c-4.2,2.2-8,5.2-11.1,8.8
				c-3.2,3.6-5.7,7.7-7.5,12.2c-0.9,2.2-1.6,4.6-2,7l-0.2,0.9l-0.1,0.4c0,0.1-0.1,0.3-0.1,0.5c-0.1,0.6-0.2,1.2-0.2,1.8l-0.2,1.8
				c0,0.6-0.1,1.2-0.1,1.8c-0.1,2.5,0.1,4.9,0.4,7.4C609.8,928.8,610.3,931.3,611.1,933.7z"/>
		</g>
		<g>
			<circle class="st5" cx="646.9" cy="915.1" r="40.6"/>
			<path class="st6" d="M611.1,933.7c-1.3-2.2-2.3-4.6-3.1-7c-0.4-1.2-0.7-2.5-1-3.8c-0.3-1.3-0.5-2.6-0.6-3.9c0-0.3-0.1-0.7-0.1-1
    ...
    if head_close_idx != -1:
        ...
        new_content = new_content[:head_close_idx] + gsap_script + new_content[head_close_idx:]
